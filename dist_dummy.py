...
class DummyDistribution(distribution.AutoCompositeTensorDistribution):
  ...
  def __init__(self,
    ...
    with tf.name_scope(name) as name:
      ...
      super(DummyDistribution, self).__init__(
          dtype=dtype,
...
@kullback_leibler.RegisterKL(DummyDistribution,DummyDistribution)
